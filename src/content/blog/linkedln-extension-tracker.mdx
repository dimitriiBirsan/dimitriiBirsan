...
Mitigations exist — separate browser profiles, dedicated containers, hardened extension setups — but that's a different talk. For now: the next time LinkedIn asks you to "add a skill to your profile," remember it already inventoried the ones in your browser. *Humbled and honoured to share this update.*
